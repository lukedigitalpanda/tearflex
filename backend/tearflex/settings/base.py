...
WSGI_APPLICATION = 'tearflex.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.environ.get('DB_NAME', 'tearflex'),
        'USER': os.environ.get('DB_USER', 'tearflex'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'tearflex'),
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'TearFlex <noreply@tearflex.com>')
FRONTEND_URL = os.environ.get('FRONTEND_URL', 'http://localhost:3000')

# File upload limits (video captures can be large)
